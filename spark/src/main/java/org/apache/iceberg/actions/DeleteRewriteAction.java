...
public class DeleteRewriteAction extends
    BaseSnapshotUpdateAction<DeleteRewriteAction, DeleteRewriteActionResult> {
  private static final Logger LOG = LoggerFactory.getLogger(DeleteRewriteAction.class);
  ...
  public DeleteRewriteAction(SparkSession spark, Table table) {
    this.table = table;
  ...
  @Override
  protected DeleteRewriteAction self() {
    return null;
  }
}
