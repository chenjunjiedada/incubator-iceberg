...
public interface DeleteRows extends SnapshotUpdate<DeleteRows> {
   ...
   */
  DeleteRows deleteFromFilter(Expression expr);

  /**
   * Delete a set of records which denotes by a {@link DataFile}.
   *
   * @param file a data file denotes the records to be deleted
   * @return this for method chaining
   */
  DeleteRows deleteFromFile(DataFile file);
